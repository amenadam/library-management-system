...
<body>
  ...
  <i class="fa-solid fa-xmark" onclick="side_menu.style.left ='-200px'; menu_n.style.display = 'block';"></i>
    ...
    <a href="books.php?Grade=9"><i class="fa-solid fa-book"> Books</i> </a>
        ...
        <a hidden href="IssueBook.php"><i class="fa-solid fa-plus"> Issue Book</i></a>
        <a hidden href="return_issue_book.php"><i class="fa-solid fa-minus"> Return Book</i></a>
        <a href="developer/dev_tools/ADD_NEW_USER.php"><i class="fa-solid fa-minus"> Add new user</i></a>
        <a href="logout.php"><i class="fa-solid fa-right-from-bracket"> LogOut</i></a>
    </div>
  </div>
  <div class="col-2">
  <h1>Welcome <?php echo $_SESSION['admin_name'] ?> </h1>
        <p>This is your home page as School Principal</p>
  </div>
    <div class="table-dev">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        System has not connected to students database
      </div>
